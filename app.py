...
# --- NAVEGAÇÃO POR ABAS (Adicionada aba "CONTAS") ---
...
# --- ABA 4: CONTAS DA CASA (Movido da Sidebar para cá) ---
with tab_contas:
    st.subheader("🏠 Gestão de Contas da Casa")
    st.write("Insira os valores das suas despesas fixas mensais:")
    ...
    st.info("Esses valores são usados para calcular o progresso de abate na aba Resultados.")
